...
Using the code above as an example, load the dataset of Pascal Siakam’s field goals made over his Raptors career (provided as an Excel file) and plot the results.
...
# Input
url = "https://raw.githubusercontent.com/Data-Dunkers/data-dunkers-modules/main/data/NBA/Pascal_Siakam.xlsx"
df = pd.read_excel(url)

# Process & Output
px.line(df, x="Season", y="FGM", title="Pascal Siakam Field Goals by Season")
```
